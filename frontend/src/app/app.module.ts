...
} from "./components/seating-plan-editor/seating-plan-editor.component";
import {
...
} from './components/event-search-result/event-search-result.component';
...
} from './components/location-admin-overview/location-admin-overview.component';
