...
function drawStandingArea(
  ...
  seatAvailability.setTransform(calculateBoxCenterPoint(areaGraphics.width, seatAvailability.width), location.h*0.05);
  ...
  plusMinusContainer.setTransform(0, seatAvailability.position.y + seatAvailability.height + location.h * 0.05 )
  ...
  if (text) {
    ...
    additionalText.setTransform(additionalText.position.x, plusMinusContainer.position.y + plusMinusContainer.height + location.h * 0.05)
