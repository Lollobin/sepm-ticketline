...
import { Show, ShowsService } from 'src/app/generated-sources/openapi';
...
export class CreateShowComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private showService: ShowsService, private route: ActivatedRoute) { }
