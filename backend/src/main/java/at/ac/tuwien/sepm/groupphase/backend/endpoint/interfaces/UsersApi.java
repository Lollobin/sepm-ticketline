...
public interface UsersApi {
     ...
     */
    @Operation(operationId = "usersGet", summary = "Gets a list of users", tags = {
        "userManagement"}, responses = {
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsersPageDto.class)))}, security = {
    ...
    /**
     * DELETE /users/{id} : Deletes the user with the given ID. Only an administrator or the user
     * itself can delete a given user account.
     *
     * @param id ID of the user that is retreived (required)
     * @return Successful deletion of an user. (status code 204) or The user is not logged in
     * (status code 401) or The user needs administrative rights (status code 403) or The user with
     * the given ID was not found (status code 404) or Internal Server Error (status code 500)
     */
    @Operation(operationId = "usersIdDelete", summary = "Deletes the user with the given ID.", tags = {
        "userManagement"}, responses = {
        ...
        @ApiResponse(responseCode = "500", description = "Internal Server Error")}, security = {
        @SecurityRequirement(name = "BearerAuth")})
     ...
     *
     * @param id ID of the user that is retreived (required)
     * @return Successful retreival of an user. (status code 200) or The user is not logged in
     * (status code 401) or The user with the given ID was not found (status code 404) or Internal
     * Server Error (status code 500)
     */
    @Operation(operationId = "usersIdGet", summary = "Retreives information of an user with the given data.", tags = {
        "userManagement"}, responses = {
        ...
        @ApiResponse(responseCode = "500", description = "Internal Server Error")}, security = {
        @SecurityRequirement(name = "BearerAuth")})
    @RequestMapping(method = RequestMethod.GET, value = "/users/{id}", produces = {
        "application/json"})
     ...
     * @return Successful update of an user. (status code 204) or The user is not logged in (status
     * code 401) or Validation failed for an input (status code 422) or Internal Server Error
     * (status code 500)
     */
    @Operation(operationId = "usersIdPut", summary = "Updates information of an user with the given data.", tags = {
        "userManagement"}, responses = {
        ...
        @ApiResponse(responseCode = "500", description = "Internal Server Error")}, security = {
        @SecurityRequirement(name = "BearerAuth")})
    @RequestMapping(method = RequestMethod.PUT, value = "/users/{id}", consumes = {
        "application/json"})
     ...
     *
     * @param userWithPasswordDto (required)
     * @return Successful creation of an user (status code 201) or Validation failed for an input
     * (status code 422) or Internal Server Error (status code 500)
     */
    @Operation(operationId = "usersPost", summary = "Registers an user with the given data.", tags = {
        "userManagement"}, responses = {
