        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"locationName\" : \"locationName\", \"ticket\" : [ { \"rowNumber\" : 6, \"sector\" : 5, \"ticketId\" : 0, \"seatNumber\" : 1 }, { \"rowNumber\" : 6, \"sector\" : 5, \"ticketId\" : 0, \"seatNumber\" : 1 } ], \"artists\" : [ { \"firstName\" : \"firstName\", \"lastName\" : \"lastName\", \"knownAs\" : \"knownAs\", \"artistId\" : 0, \"bandName\" : \"bandName\" }, { \"firstName\" : \"firstName\", \"lastName\" : \"lastName\", \"knownAs\" : \"knownAs\", \"artistId\" : 0, \"bandName\" : \"bandName\" } ], \"city\" : \"city\", \"eventName\" : \"eventName\", \"type\" : \"purchased\", \"showDate\" : \"2000-01-23T04:56:07.000+00:00\" }";
