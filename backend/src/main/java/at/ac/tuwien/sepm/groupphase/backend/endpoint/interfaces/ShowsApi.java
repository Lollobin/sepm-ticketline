...
public interface ShowsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"date\" : \"2000-01-23T04:56:07.000+00:00\", \"showId\" : 0, \"event\" : 6.027456183070403 }";
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Successful creation of a show", content = @Content(mediaType = "application/json", schema = @Schema(implementation =  ShowDto.class))),
            @ApiResponse(responseCode = "401", description = "The user is not logged in"),
    ...
    default ResponseEntity<ShowDto> showsPost(
