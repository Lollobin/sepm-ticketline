...
public interface ShowsApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"shows\" : [ { \"date\" : \"2000-01-23T04:56:07.000+00:00\", \"showId\" : 0, \"artists\" : [ 6, 6 ], \"minPrice\" : 5.962133916683182, \"location\" : { \"address\" : { \"country\" : \"country\", \"zipCode\" : \"zipCode\", \"city\" : \"city\", \"street\" : \"street\", \"houseNumber\" : \"houseNumber\" }, \"locationId\" : 1, \"name\" : \"name\" }, \"event\" : { \"duration\" : 6.027456183070403, \"eventId\" : 0, \"name\" : \"name\", \"content\" : \"content\" } }, { \"date\" : \"2000-01-23T04:56:07.000+00:00\", \"showId\" : 0, \"artists\" : [ 6, 6 ], \"minPrice\" : 5.962133916683182, \"location\" : { \"address\" : { \"country\" : \"country\", \"zipCode\" : \"zipCode\", \"city\" : \"city\", \"street\" : \"street\", \"houseNumber\" : \"houseNumber\" }, \"locationId\" : 1, \"name\" : \"name\" }, \"event\" : { \"duration\" : 6.027456183070403, \"eventId\" : 0, \"name\" : \"name\", \"content\" : \"content\" } } ], \"currentPage\" : 5, \"numberOfResults\" : 2, \"pagesTotal\" : 7 }";
    ...
    default ResponseEntity<ShowDto> showsIdGet(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"date\" : \"2000-01-23T04:56:07.000+00:00\", \"showId\" : 0, \"artists\" : [ 6, 6 ], \"minPrice\" : 5.962133916683182, \"location\" : { \"address\" : { \"country\" : \"country\", \"zipCode\" : \"zipCode\", \"city\" : \"city\", \"street\" : \"street\", \"houseNumber\" : \"houseNumber\" }, \"locationId\" : 1, \"name\" : \"name\" }, \"event\" : { \"duration\" : 6.027456183070403, \"eventId\" : 0, \"name\" : \"name\", \"content\" : \"content\" } }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
