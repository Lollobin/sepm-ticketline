...
public interface BillApi {
    ...
    /**
     * GET /bill/{id} : Gets a PDF version of a bill
     *
     * @param id ID of the transaction that is retreived (required)
     * @return Successful retreival of orders (status code 200) or The user is not logged in (status
     * code 401) or The user needs administrative rights (status code 403) or The given transaction
     * id was not found (status code 404) or Internal Server Error (status code 500)
     */
    @Operation(
        operationId = "billIdGet",
    ...
    default ResponseEntity<org.springframework.core.io.Resource> billIdGet(
        @Parameter(
            name = "id",
